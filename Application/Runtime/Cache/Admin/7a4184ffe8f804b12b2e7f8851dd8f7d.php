        ...
        <div class="boxed">
            ...
            <div id="content-container">
                ...
                <div class="panel">
                    ...
                    <!--===================================================-->
                    <div class="panel-heading">
                        <h3 class="panel-title"><a class="btn btn-info btn-rounded" href="<?php echo U('Admin/Article/add_art');?>">新增文章</a></h3>
                    </div>
							...
							<thead>
							    ...
							    <tbody>
							        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							            ...
							            <td>
							            	<a type="button" class="btn btn-warning  btn-xs btn-rounded" href="<?php echo U('Admin/Article/edi_art',array('id'=>$vo['id']));?>">  编辑  </a>
							            	&nbsp;&nbsp;
							           		<a  type="button" class="btn btn-danger  btn-xs btn-rounded"  href="javascript:if(confirm('确认删除这篇文章？'))location='<?php echo U('Admin/Article/del_art',array('id'=>$vo['id']));?>'">  删除  </a>
							            </td>
                            ...
                            <div class="nano-content">
                                ...
                                <div id="mainnav-profile" class="mainnav-profile">
                                    ...
                                    <div id="profile-nav" class="collapse list-group bg-trans">
                                        ...
                                        <a href="../Admin/Index/logout" class="list-group-item">
                ...
                <div class="modal-body">
                    <form class="form-inline" action="<?php echo U('Admin/Rule/add_group');?>" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="请输入角色"  id="demo-inline-inputmail" class="form-control" name="title">
                        </div>
    ...
    <div class="modal fade" id="thinkright-adduser" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
         <div class="modal-dialog">
             <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-inline" action="<?php echo U('Admin/Rule/add_user');?>" method="post">
                        <div class="form-group">
                            <label for="demo-inline-inputmail" class="sr-only">成员名：</label>
                            <input type="text" placeholder="请输入角色的成员"  id="demo-inline-inputmail" class="form-control" name="title">
