        ...
        <ul class="ul">
            <?php if(is_array($auth_rule)): foreach($auth_rule as $key=>$vo): ?><li class="li">
                    <?php if($vo['line'][0] != ''): echo ($vo['title']); ?>
                        <div class="class">
                            <ul>
                                <?php if(is_array($vo['line'])): $i = 0; $__LIST__ = $vo['line'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$f): $mod = ($i % 2 );++$i;?><li><a href="/right/<?php echo ($f['name']); ?>"><?php echo ($f['title']); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                            </ul>
                        </div>
                        <?php else: ?>
                        <a href="/right/<?php echo ($vo['name']); ?>"><?php echo ($vo['title']); ?></a><?php endif; ?>
