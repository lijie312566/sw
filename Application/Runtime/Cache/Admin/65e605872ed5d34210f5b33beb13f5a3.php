                            ...
                            <div class="row">
                                <div class="col-sm-6 text-xs-center">
                                    <div class="form-group">
                                        <a href="<?php echo U('Admin/User/add_user');?>"><button id="demo-btn-addrow" class="btn btn-purple"><i class="demo-pli-plus"></i> Add New Roles</button></a>
                                    </div>
                                </div>
                        ...
                        <table id="demo-foo-addrow" class="table table-bordered table-hover toggle-circle" data-page-size="7">
                            ...
                            <tbody>
                                <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                                        ...
                                        <td>
                                            <a href="<?php echo U('Admin/User/edit_user',array('id'=>$v['id']));?>">修改权限或密码</a>
                                        </td>
