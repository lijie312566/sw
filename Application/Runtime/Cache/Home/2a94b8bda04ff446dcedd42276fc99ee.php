...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/right/Public/admin/css/login.css"/>
	...
	<body>
		<div class="login_content">
			<img class="logo" src="/right/Public/admin/img/logo.png"/>
			<div class="title">
				<h2>双维科技信息管理平台</h2>
			...
			<div class="login_mes">
                <form action="index.html" method="post">
					...
					<input type="submit" class="sub btn btn-primary btn-lg btn-block" value="立即登录"/>
				</form>
			</div>
			<div class="foot">
				<span>©2017&nbsp;&nbsp;京ICP证030173号</span>
			</div>
		</div>
